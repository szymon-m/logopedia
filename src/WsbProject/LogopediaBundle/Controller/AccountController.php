...
use WsbProject\LogopediaBundle\Form\Model\UserRegistration;
use WsbProject\LogopediaBundle\Entity\User;
...
class AccountController extends Controller
{
     ...
     * @Template("LogopediaBundle:Account:register.html.twig")
     */
